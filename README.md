...
| Ë®≠Â? | Edit and save `data/profiles/default/run.yaml` |


| ?êË¶Ω | Capture frame thumbnail to `logs/frame.png` |


| ?•Ë? | Live structlog output |
...
Manual checklist: [docs/manual-test-v0.2.md](docs/manual-test-v0.2.md).
...
## v0.2ÔºàQuest profile + Â∞éËà™ÔºèÊà∞È¨•ËÖ≥?¨Ô?



- script_version: v0ÔºàÈ?Ë®≠Ô?Á∂≠Ê? v0.1 Ë°åÁÇ∫Ôº?2 ?Ä quest_profile??
- ÁØÑ‰??úÂç°Ôºöexamples/quests/treasure_door_extreme/Ôº?
avigation.yaml??attle.yamlÔºâ„Ä?
- Catalog ‰æ?display_preset ËºâÂÖ•Ôºödata/catalog/{width}x{height}/ÔºàË? ADR-0005Ôºâ„Ä?
- CLIÔº?go-auto run -c run.yaml --quest-profile treasure_door_extreme

- GUIÔºöË®≠ÂÆöÂ??ÅÂèØ??v2 ?áÈ???idÔºõÊ®°?øÂ∫´?ÜÈ??ØÂ???catalog Â≠êÁõÆ?Ñ„Ä?


?ãÂ?È©óÊî∂Ê∏ÖÂñÆÔºödocs/manual-test-v0.2.md
